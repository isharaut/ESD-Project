...
cluster create (one time)
database created (multi)
collection create (multi)
database access - (multi) username, password, role(admin)
network access - whitelist (one time)
*/
